...
export const metadata: Metadata = { title: "FAQ — CollabShield" };
export default function FaqPage() { return <DocumentPage label="FAQ" title="Questions, answered">
  ...
  <h2>Can a major website receive a warning?</h2><p>Yes. Complex sites may use compatibility policies, return different headers by region, or intentionally accept a defense-in-depth tradeoff. CollabShield explains the evidence instead of claiming exploitation.</p>
  <h2>Does CollabShield retain URLs?</h2><p>The application does not store scan history. Production infrastructure may create short-lived operational logs; target identifiers are hashed by the application.</p>
