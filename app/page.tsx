  ...
  return <>
    ...
    <main>
      ...
      <section id="how-it-works" className="process shell">
        ...
        <div className="section-intro"><span className="eyebrow">HOW IT WORKS</span><p>ShieldCircle turns complex response headers into a report you can act on in seconds.</p></div>
        <div className="steps">
