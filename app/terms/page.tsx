...
export const metadata: Metadata = { title: "Terms and Responsible Use — ShieldCircle" };
export default function TermsPage() { return <DocumentPage label="TERMS" title="Responsible use">
  <p>Last updated: September 19, 2026.</p><h2>Authorized use</h2><p>You may scan only public systems you own or are authorized to assess. Do not use ShieldCircle to disrupt services, evade controls, or facilitate unlawful activity.</p>
