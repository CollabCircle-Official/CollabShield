...
export const metadata: Metadata = { title: "Scoring Methodology — ShieldCircle", description: "How ShieldCircle evaluates HTTP response-header configuration." };

export default function MethodologyPage() {
  return <DocumentPage label="METHODOLOGY 2.1" title="Transparent by design">
    <p>ShieldCircle evaluates the response returned to its server-side scanner. The grade describes observed header configuration, not the overall security of a website.</p>
    ...
    <h2>Limitations</h2><p>A response can vary by geography, user agent, authentication state, cookies, path, and deployment edge. ShieldCircle does not exploit targets, execute application code, or certify compliance. A finding is not proof of a vulnerability.</p>
  </DocumentPage>;
}
