...
export const metadata: Metadata = { title: "Privacy — ShieldCircle" };
export default function PrivacyPage() { return <DocumentPage label="PRIVACY" title="Minimal data by default">
  <p>Last updated: September 19, 2026.</p><h2>Scan data</h2><p>ShieldCircle processes submitted public URLs to perform the requested scan. It does not provide user accounts, maintain a scan-history database, or intentionally retain report contents.</p>
